                                        ...
                                        <div class="col-md-8">
                                            <div class="form-section">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <textarea class="form-control" id="productDescription" rows="5" placeholder="Enter detailed product description"></textarea>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-section">
                                                ...
                                                <div class="image-upload-container mb-3" id="featuredImageUpload">
                                                    ...
                                                    <input type="file" id="featuredImageInput" class="d-none">
                                                </div>
                                                <div class="image-preview-container d-flex flex-wrap" id="featuredImagePreview"></div>
                                            </div>
                                ...
                                <div class="tab-pane fade" id="media" role="tabpanel">
                                    <div class="form-section">
                                        ...
                                        <div class="image-upload-container mb-4" id="galleryUpload">
                                            ...
                                            <input type="file" id="galleryInput" class="d-none" multiple>
                                        </div>
                                        <div class="image-preview-container d-flex flex-wrap" id="galleryPreview">
                                            <div class="image-preview">
                                                <img src="https://images.unsplash.com/photo-1505740420928-5e560c06d30e?ixlib=rb-1.2.1&auto=format&fit=crop&w=100&h=100&q=80" alt="Product">
                                                <div class="remove-btn">
                                                    <i class="fas fa-times"></i>
                                                </div>
                                            </div>
                                            <div class="image-preview">
                                                <img src="https://images.unsplash.com/photo-1590658268037-6bf12165a8df?ixlib=rb-1.2.1&auto=format&fit=crop&w=100&h=100&q=80" alt="Product">
                                                <div class="remove-btn">
                                                    <i class="fas fa-times"></i>
                                                </div>
                                            </div>
                                            <div class="image-preview">
                                                <img src="https://images.unsplash.com/photo-1593784991095-a205069470b6?ixlib=rb-1.2.1&auto=format&fit=crop&w=100&h=100&q=80" alt="Product">
                                                <div class="remove-btn">
                                                    <i class="fas fa-times"></i>
                                                </div>
                                            </div>
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="form-section">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control" id="productPrice" placeholder="0.00">
                                                    </div>
                                                </div>
                                                <div class="mb-3">
                                                    ...
                                                    <div class="input-group">
                                                        <span class="input-group-text">$</span>
                                                        <input type="text" class="form-control" id="productComparePrice" placeholder="0.00">
                                                    </div>
                                                    <div class="form-text">To show a reduced price, enter the original price here.</div>
                                                </div>
                                                <div class="mb-3">
                                                    <label for="productCost" class="form-label">Cost per Item</label>
                                                    <div class="input-group">
                                                        <span class="input-group-text">$</span>
                                                        <input type="text" class="form-control" id="productCost" placeholder="0.00">
                                                    </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-section">
                                                ...
                                                <div class="mb-3">
                                                    <label for="productBarcode" class="form-label">Barcode (ISBN, UPC, GTIN, etc.)</label>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-section">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="productSku" placeholder="e.g. SN-WH1000XM4-BLK">
                                                </div>
                                                <div class="mb-3">
                                                    <div class="form-check">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-section">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="number" class="form-control" id="restockThreshold" value="10">
                                                    <div class="form-text">Get notified when inventory drops below this number.</div>
                                                </div>
                                                <div class="mb-3">
                                                    <label for="restockQuantity" class="form-label">Restock Quantity</label>
                                                    <input type="number" class="form-control" id="restockQuantity" value="100">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-section">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <div class="form-text">Shipping classes are used by certain shipping methods to group similar products.</div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="form-section">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control" id="seoUrl" placeholder="sony-wh-1000xm4">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-section">
                                                ...
                                                <div class="card">
                                                    <div class="card-body">
                                                        <div class="mb-2">
                                                            <h6 class="text-primary mb-0">Sony WH-1000XM4 Wireless Noise Cancelling Headphones</h6>
                                                            <small class="text-success">https://example.com/products/sony-wh-1000xm4</small>
                                                        </div>
                                                        <p class="small text-muted mb-0">
                                                            Industry-leading noise cancellation with Dual Noise Sensor technology. Up to 30-hour battery life with quick charging. Touch sensor controls for easy operation.
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
